export const siteData = {
  ...
  seoDescription:
    "A premium cinematic Hindu Telugu Andhra wedding invitation website with modern luxury design, traditions, events, countdown, and sharing tools.",
  ...
  contact: {
    ...
    venueNote: "Please check the maps link on the Events page for the exact venue."
  }
} as const;
